...
Los desarrollos y avances inform\'aticos de Argentina siempre estuvieron intimamente relacionados con la situaci\'on pol\'itica que se estaba atravezando. La gran cantidad de gobiernos militares imposibilitaron, en muchos momentos, los avances de una gran cantidad de proyectos. 

La llegada de la primera computadora, Clementina, a la Universidad de Buenos Aires se considera uno de los acontesimientos m\'as importantes de la computaci\'on en nuestro pa\'is, muchos aseguran que dicho suceso marc\'o el nacimiendo de los desarrollos inform\'aticos en Argentina.
...
existieron varios proyectos de empresas nacionales, que generaron muy buenos resultados, pero que no perduraron mucho tiempo en el mercado. Todav\'ia se pueden conseguir computadoras nacionales marca Czerweny, Talent, entre otras.
...
Actualmente, las carreras tecnol\'ogicas, como es el caso de las de computaci\'on, forman parte de uno de los pilares m\'as abordados, entre los objetivos de los planes politicos.
 
En el desarrollo del presente trabajo profundizaremos en proyectos, tanto a nivel industrial como acad\'emico, que mostraran las distintas situaciones aboradadas por nuestro pa\'is en las diferentes etapas politicas. 
