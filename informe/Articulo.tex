...
%----------------------------------------------------------------------
\section{Actualidad }
Si nos posicionamos a fines de la decada de los 90 hasta el momento, no es dif\'icil ver que la computaci\'on, la tecnolog\'ia y los instrumentos digitales se han adue\~nado de la mayor\'ia de los quehaceres cotidianos de las personas. Debido al bien conocido proceso de globalizacion\footnote{La globalización es un proceso fundamentalmente econ\'omico que consiste en la creciente integraci\'on de las distintas econom\'ias nacionales en una \'unica econom\'ia de mercado mundial.} la obtenci\'on de material tecnol\'ogico es una tarea bastante m\'as sencilla que en decadas pasadas.

A pesar de que el uso de instrumentos tecnol\'ogicos aumenta cada a\~no, no sucede lo mismo con el desarrollo nacional de los mismos. La mayor parte de la tecnolog\'ia es importada. Esto explica el tan familiar ``Made in china'' de la gran parte de los productos que tenemos en casa.

Si bien cuando buscamos empresas o negocios dedicados al rubro de la computaci\'on, nos encontramos con millones en nuestro pa\'is, la mayor parte de ellos (para no decir la totalidad) estan dedicados al ensamblado de equipos, con componentes bajo licencia y norma importada.

Actualmente se encuentran en nuestro pa\'is sucursales de empresas de importancia mundial pertenecientes al rubro de la computaci\'on, pero en su mayor\'ia se dedican mayormente al desarrollo de `` Software''. Entre ellas se encuentran: INTEL, MOTOROLA e IBM.

Con respecto a la parte academica y de investigaci\'on, la rama de la computaci\'on atravieza un momento plagado de planes de incentivo. Los mismos se deben a planes de becas por parte del gobierno como becas Tics, PNBU, Bicentenario y de empresas privadas (entre ellas estas INTEL).

Si nos situamos en el tercer mileño, la informatica atravieza un periodo con muchisimo auge. Existen gran cantidad de escuelas informaticas como son el caso de CACIC, ECI, RIO, etc. Las cuales forman un papel importantisimo en el desarrollo academico y profesional.
