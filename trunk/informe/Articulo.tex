...
\begin{abstract} 
Los desarrollos y avances inform\'aticos de Argentina siempre estuvieron intimamente relacionados con la situaci\'on pol\'itica que se estaba atravezando. La gran cantidad de gobiernos militares imposibilitaron, en muchos momentos, los acanves de una gran cantidad de proyectos. 

La llegada de la primera computadora, Clementina, a la Universidad de Buenos Aires se encuentra en uno de los acontesimientos mas impostantes de la computaci\'on en el pais, muchos aseguran que \'este suceso marc\'o el nacimiendo de los desarrollos informaticos en Argentina.
...
A nivel industrial, nuestro pa\'is no se encuentra entre los paises productores de instrumentos digitales, pero existieron varios proyectos de empresas nacionales, que generaron muy buenos resultados pero que no perduraron en el mercado. Todav\'ia se pueden conseguir computadoras nacionales marca Czerweny, Talent, entre otras.
...
En el desarrollo del presente trabajo profundizaremos en proyectos, tanto a nivel industrial como academico, que mostraran las diferentes etapas vividas por nuestro pais. 
